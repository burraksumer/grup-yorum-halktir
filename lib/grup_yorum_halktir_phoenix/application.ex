defmodule GrupYorumHalktirPhoenix.Application do
  ...
  def start(_type, _args) do
    children = [
      GrupYorumHalktirPhoenixWeb.Telemetry,
      ...
      # {GrupYorumHalktirPhoenix.Worker, arg},
      # Start to serve requests, typically the last entry
      GrupYorumHalktirPhoenixWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: GrupYorumHalktirPhoenix.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    GrupYorumHalktirPhoenixWeb.Endpoint.config_change(changed, removed)
    :ok
  end
